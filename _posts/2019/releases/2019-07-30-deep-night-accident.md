...
运行了好几年的老系统，使用的是传统的垂直架构，（架构演进可以参考这篇文章：[从架构演进的角度聊聊Spring Cloud都做了些什么？](http://www.intelyes.xyz/springcloud/2017/11/02/framework-and-springcloud.html)），各种业务、政策、活动、风控都揉在了一起。
