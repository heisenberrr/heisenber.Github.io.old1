...
#这里的配置表示，访问/it/** 直接重定向到http://www.intelyes.xyz/**
zuul.routes.baidu.path=/it/**
zuul.routes.baidu.url=http://www.intelyes.xyz/
```
...
启动```gateway-service-zuul-simple```项目，在浏览器中访问：```http://localhost:8888/it/spring-cloud```，看到页面返回了：```http://www.intelyes.xyz/spring-cloud ``` 页面的信息，如下：
...
-------------
**作者：纯洁的微笑**  
**出处：[http://www.intelyes.xyz/](http://www.intelyes.xyz/springcloud/2017/06/01/gateway-service-zuul.html)**      
**版权归作者所有，转载请注明出处** 
