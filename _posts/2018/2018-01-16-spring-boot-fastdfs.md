...
上篇文章介绍了[如何使用 Spring Boot 上传文件](http://www.intelyes.xyz/springboot/2018/01/12/spring-boot-upload-file.html)，这篇文章我们介绍如何使用 Spring Boot 将文件上传到分布式文件系统 FastDFS 中。
